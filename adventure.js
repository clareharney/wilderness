...
console.log(`We offer expert guidance on ${totalRiver} miles of scenic rivers accross the US`);
...
console.log(`${mostExpensiveTrails}`)

const leastExpensiveTrails = cheapTrails(trails)
console.log(`${leastExpensiveTrails}`)